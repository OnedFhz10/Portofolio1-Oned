...
const Contact = () => {
  // ID Formspree Anda sudah dimasukkan di sini:
  const [state, handleSubmit] = useForm("mqarlkqg");

  // Jika pesan berhasil terkirim, tampilkan pesan terima kasih
  if (state.succeeded) {
    return (
      <section id="contact" className="py-20 bg-gray-800 text-white text-center">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <button 
            ...
            className="mt-6 px-6 py-2 bg-gray-700 rounded-full hover:bg-gray-600 transition-colors"
          >
            Kembali ke Form
          </button>
        </div>
    ...
    <section id="contact" className="py-20 bg-gray-800 text-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto">
          {/* Form menggunakan handleSubmit dari Formspree */}
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="text-center">
              <button 
                ...
                className="px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 rounded-lg font-bold transition-all transform hover:scale-105 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
              >
