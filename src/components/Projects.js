  ...
  const projectData = [
    {
      ...
      description: "Website pribadi modern dengan animasi dan SEO optimization.",
      image: "/project1.jpg", 
    ...
    },
    {
      ...
      description: "Manajemen tugas sederhana dengan penyimpanan lokal browser.",
      image: "", 
      tech: ["React", "CSS"],
      category: "Web App",
      link: "#",
    ...
    {
      id: 3,
      title: "Redesign UI Tokopedia",
      description: "Eksplorasi desain antarmuka aplikasi e-commerce agar lebih user friendly.",
      image: "",
      tech: ["Figma", "UI/UX"],
    ...
    },
    {
      ...
      description: "Backend sistem kasir menggunakan Node.js dan database SQL.",
      image: "",
      tech: ["Node.js", "MySQL"],
      category: "Backend",
      link: "#",
