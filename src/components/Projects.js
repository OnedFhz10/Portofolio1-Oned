  ...
  const projectData = [
    {
      ...
      description: "Website pribadi yang dibangun dengan Next.js dan Tailwind CSS.",
      image: "/project1.jpg", 
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projectData.map((project, index) => (
            <div 
              key={project.id} 
              // Menambahkan animasi fade-up dengan delay bertingkat
              data-aos="fade-up"
              data-aos-delay={index * 100} // Kartu 1: 0ms, Kartu 2: 100ms, dst.
              className="bg-gray-800 rounded-xl overflow-hidden shadow-lg hover:transform hover:scale-105 transition-all duration-300 border border-gray-700"
            >
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {project.tech.map((t, i) => (
                    <span key={i} className="px-3 py-1 bg-gray-900 text-xs text-blue-300 rounded-full border border-gray-700">
                      {t}
                    </span>
                  ))}
                </div>
